...
function simulateContractInteraction() {
  ...
  const interactions = [
    { type: 'Transfer', from: '0xabcd...1234', to: '0x5678...90ab', amount: '100 Tokens' },
    { type: 'Mint', to: '0x9876...5432', amount: '50 Tokens' },
    { type: 'Transfer', from: '0x4567...890a', to: '0xbcde...f012', amount: '25 Tokens' },
