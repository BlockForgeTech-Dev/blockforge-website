    ...
    configuration.addEventListener("input", (event) => {
      ...
      if (inputField.id === "token-supply") {
        ...
        if (tokenSupply > 1000000) {
          aiSuggestion.textContent =
            "AI Suggestion: Consider a lower supply for scarcity.";
        } else {
          aiSuggestion.textContent = "";
        }
        ...
        if (tokenName.length > 0 && tokenName.length < 3) {
          aiSuggestion.textContent =
            "AI Suggestion: Token name should be at least 3 characters.";
        } else if (tokenName.length > 20) {
          aiSuggestion.textContent =
            "AI Suggestion: Token name is too long, consider a shorter name.";
        } else {
          aiSuggestion.textContent = "";
        }
        ...
        if (tokenSymbol.length > 0 && tokenSymbol.length < 2) {
          aiSuggestion.textContent =
            "AI Suggestion: Token symbol should be at least 2 characters.";
        } else if (tokenSymbol.length > 5) {
          aiSuggestion.textContent =
            "AI Suggestion: Token symbol is too long, consider a shorter symbol.";
        } else {
          aiSuggestion.textContent = "";
        }
      }
